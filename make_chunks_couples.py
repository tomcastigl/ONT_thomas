...
chunksize=500
traindf=pd.read_pickle('/work/upnae/thomas_trna/data/classification_dataset_conformer_12keach/train.pkl')
valdf=pd.read_pickle('/work/upnae/thomas_trna/data/classification_dataset_conformer_12keach/val.pkl')
...
for i,row in traindf.iterrows():
    if (row.dataset == 'h5mC') or (row.dataset == 'm6A'):
...
train_chunks_df.to_pickle('/work/upnae/thomas_trna/data/classification_dataset_conformer_chunks_curlk_500_h5mc_m6a/train.pkl')
val_chunks_df.to_pickle('/work/upnae/thomas_trna/data/classification_dataset_conformer_chunks_curlk_500_h5mc_m6a/val.pkl')
