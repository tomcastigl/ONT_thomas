...
couples_adapt=[['/scratch/tcastigl/data/tailfindr_res/m6A_4.csv', '/scratch/tcastigl/data/pkl_data/m6A_4_df.pkl'],
              ['/scratch/tcastigl/data/tailfindr_res/m5C_1.csv', '/scratch/tcastigl/data/pkl_data/m5C_1_df.pkl'],
              ['/scratch/tcastigl/data/tailfindr_res/UNM_22.csv', '/scratch/tcastigl/data/pkl_data/UNM_22_df.pkl'],
...
for couple in couples_adapt:
    ...
    if ONT_df.shape[0] != 0:
        merged_df=ONT_df.merge(tailfindres_df,how='inner',on='read_id').head(6000)
...
print(adapt_df.info())
print(adapt_df.dataset.unique())
adapt_df.to_pickle('/work/upnae/thomas_trna/data/val_set_adapters_only2/val.pkl')
...
#X_train.to_pickle('/work/upnae/thomas_trna/data/val_set_adapters_onlyadapt_train.pkl')
#X_val.to_pickle('/work/upnae/thomas_trna/data/adapt_val.pkl')
